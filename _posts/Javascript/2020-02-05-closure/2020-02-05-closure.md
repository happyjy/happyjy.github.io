...
* event Listener callback function에 bind 사용
  ...
  var consoleColor = function(color) {
    if (this === window) {
      //POINT3, POINT2
      console.log(
        "### this is window -> " + this + "/// callback function param: " + color
      )
  ...
  colorList.forEach(function(fruit) {
    ...
    $li.addEventListener("click", consoleColor.bind(this, fruit)) //POINT 2: forEach의 callback function에서 this는 "window"/ fruit는 "clousre"
    $ul.appendChild($li)
  })
  document.body.appendChild($ul)
...
![curryingFunction](curryingFunction.png)
